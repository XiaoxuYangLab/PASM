...
A [Python version for RNA bams](https://github.com/XiaoxuYangLab/PASM/tree/master/RNA_PASM) is available by Xiaoxu Yang (2025-12-25).

A [new Python version](https://github.com/shishenyxx/PASM/tree/master/2019-09-25-new-python-MAF-binom-calculator) with exact binomial CIs was implemented by Xin Xu supervised by Xiaoxu Yang (2019-07-24), fixed by Jiawei Shen (2022-04-22) and Weizhen Zhou (2025-04-24).
