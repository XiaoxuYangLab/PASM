...
## Before starting:
[NumPy](https://numpy.org/) v=1.21.5, [pandas](https://pandas.pydata.org/) v=1.3.5, tables v=3.7.0, and [scipy](https://www.scipy.org/) v=1.7.3 packages should be available for your Python v=3.7.16.
